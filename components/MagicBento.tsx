...
const cardData = [
  {
    orbitId: OrbitId.Tasks,
    color: '#060010',
    title: 'Tasks',
    description: 'Manage your daily to-dos',
    label: 'Get Productive'
  },
  {
    orbitId: OrbitId.Learn,
    color: '#060010',
    title: 'Learn',
    description: 'Track topics and study sessions',
    label: 'Master It'
  },
  {
    orbitId: OrbitId.Finance,
    color: '#060010',
    title: 'Finance',
  ...
  {
    orbitId: OrbitId.Health,
    color: '#060010',
    title: 'Health',
    description: 'Log metrics for a balanced life',
    label: 'Be Well'
  },
  {
    orbitId: OrbitId.Reflect,
    color: '#060010',
    title: 'Reflect',
    description: 'Review your week, set goals',
    label: 'Grow'
  },
  {
    orbitId: OrbitId.Connect,
    color: '#060010',
    title: 'Connect',
    description: 'Collaborate with your trio',
    label: 'Team Up'
  }
];
...
const GlobalSpotlight: React.FC<GlobalSpotlightProps> = ({
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (e: MouseEvent) => {
      ...
      // FIX: Remove generic from querySelectorAll and cast inside the loop to fix TypeScript error.
          ...
          if (enableStars) {
            return (
              <ParticleCard
                key={index}
                {...cardProps}
                onClick={() => setActiveOrbit(card.orbitId)}
                disableAnimations={shouldDisableAnimations}
