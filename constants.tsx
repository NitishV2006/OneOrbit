...
const ReflectIcon = (props: React.SVGProps<SVGSVGElement>) => (
...
const ConnectIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m-7.5-2.962c.57-1.023-.19-2.057-1.282-2.43M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0ZM6.94 8.72c-.57 1.023.19 2.057 1.282 2.43m7.5 2.962c-.57 1.023.19 2.057 1.282 2.43m-7.5-2.962c.57-1.023-.19-2.057-1.282-2.43m11.25-6.132c.57-1.023-.19-2.057-1.282-2.43M6.94 15.28c.57-1.023-.19-2.057-1.282-2.43m7.5-2.962c.57 1.023.19 2.057 1.282 2.43M4.5 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm15 0a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" /></svg>
);
...
export const NAVIGATION_ITEMS = [
  { id: OrbitId.Home, label: 'Home', icon: HomeIcon },
  { id: OrbitId.Learn, label: 'Learn', icon: LearnIcon },
  { id: OrbitId.Tasks, label: 'Tasks', icon: TasksIcon },
  { id: OrbitId.Finance, label: 'Finance', icon: FinanceIcon },
  { id: OrbitId.Health, label: 'Health', icon: HealthIcon },
  { id: OrbitId.Reflect, label: 'Reflect', icon: ReflectIcon },
  { id: OrbitId.Connect, label: 'Connect', icon: ConnectIcon },
  { id: OrbitId.Profile, label: 'Profile', icon: ProfileIcon },
];
